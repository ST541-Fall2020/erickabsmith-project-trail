...
Export plot
```{r}
ggsave("parallel-bootstrap-distribution-plot.tiff", plot=parallel_bootstrap_dist_plot, path="../results")
```
...
parallel_means_and_ci %>%
  kbl() %>%
  kable_minimal(full_width = F) %>%
  save_kable(file="../results/parallel-means-and-ci.html")
```
