---
title: "03_run-bootstrap"
output: github_document
---

This file runs the sequential bootstrap described in `README.md` *I. Sequential*. It requires the `bootstrap_functions.R` file and the `results/pct_completions.rds` data. It outputs two files, the `results/bootstrap-resamples.rds` which includes all of the resamples, and the `results/mean-and-ci.rds` file which just contains those summary statistics. 
